...
export default class Innerbagnail extends Component {
  constructor(props) {
    super(props);
  ...
  Submit=()=>{
    ...
    //   console.log(this.state.DispacthItem)  
        axios.post("https://highgrip.in/api/InserIntInner",{ptype:this.state.code,brand:this.state.selectedbrand,cous:this.state.enteredbora})
        .then(response=>{
...
<View style={styles.container}>
    ...
    <Text style={styles.head}>Inner Bag</Text>
