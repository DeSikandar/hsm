...
export default class ProductDetails extends React.Component{
    ...
    componentDidMount(){
        ...
        return fetch(`https://highgrip.in/api/getsize?id=${this.props.route.params.id}`)
        ...
        //    console.log(this.props.route);
            ...
            return fetch('https://highgrip.in/api/getTransfertoass')
    ...
    clickhandler(){
      this.setState({
        ...
        axios.post("https://highgrip.in/api/stockoutar",{sizes:this.state.inputData,id:this.state.id,to:this.state.slec})
        .then(response=>{
        ...
        if(isLoading){
            ...
            var _items = dataSource.map((key,value) => {
                return <View  key={value} style={styles.bg}>
                        ...
                        <TextInput style={styles.inbag}  placeholder="En. Bag" onChangeText={(text) => this.addValues(text, key.id)} />
                        <Text style={styles.inperbag} >{key.perbag}</Text>
...
const styles = StyleSheet.create({
    ...
    text:{
      ...
      inbag:{borderWidth:1,alignSelf:"flex-start",color:"#fff",padding:10,width:"20%", height:"75%", marginRight:10, color:"#000",textAlign:"center",},
      inperbag:{borderWidth:1,alignSelf:"flex-start",color:"#fff",paddingTop:10, paddingBottom:10,paddingLeft:4, paddingRight:4, width:"20%", marginRight:10, color:"#000",textAlign:"center",},
    size:{
