...
export default class NailAssmOut extends React.Component{
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        return fetch("https://highgrip.in/api/packingNailSize")
        ...
        if(this.state.inputData&&this.state.inputData.length){
            if(this.state.slec&&this.state.slec.length){
                if(this.state.slec.length==this.state.inputData.length){
                    ...
                    axios.post("https://highgrip.in/api/Nailpackingout",{box:this.state.inputData,whome:this.state.slec})
                    .then((response)=>{
