...
export default class NailsOUt extends React.Component{
    constructor(props){
        super(props);
    ...
    addValues = (text, index) => {
      ...
      clickhandler(){
        ...
        if(this.state.inputData&&this.state.inputData.length){
            ...
            axios.post("https://highgrip.in/api/NailsInsertproduct",{data:this.state.inputData})
            .then((response)=>{
           ...
           return <View  style={styles.container}>
            ...
            return(
                <View style={styles.container}>
                    ...
                    <Text style={styles.bag}>Weight</Text>
                    </View>
                    <View >
                    </View>
...
const styles = StyleSheet.create({
    ...
    inkg:{borderWidth:1,alignSelf:"flex-start",color:"#fff",padding:10,width:"31%", height:"75%",  color:"#000",textAlign:"center",},
