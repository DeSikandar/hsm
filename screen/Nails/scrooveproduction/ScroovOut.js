...
export default class ScroovOut extends React.Component{
    constructor(props){
        super(props);
    ...
    addValues = (text, index) => {
      ...
      clickhandler(){
        ...
        if(this.state.inputData&&this.state.inputData.length){
            ...
            axios.post("https://highgrip.in/api/ScrooveInsertproduct",{data:this.state.inputData})
            .then((response)=>{
...
const styles = StyleSheet.create({
    ...
    head:{ 
        ...
        marginTop:20,
            ...
            inkg:{borderWidth:1,alignSelf:"flex-start",color:"#fff",paddingTop:10, paddingBottom:10,paddingLeft:4, paddingRight:4, width:"31%", color:"#000",textAlign:"center",},
        size:{
