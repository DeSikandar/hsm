...
export default class ScroovStock extends React.Component{
    constructor(props){
        super(props);
        this.state={
            data:[],
    ...
    componentDidMount(){
        return fetch('https://highgrip.in/api/scrooveremain')
        .then((response)=>response.json())
        .then((responseJson)=>{
            const ds=[]
            responseJson.map((item,value)=>{
                ds.push({key:value,quantity:item.Quantity,thiknesh:item.thiknesh});
