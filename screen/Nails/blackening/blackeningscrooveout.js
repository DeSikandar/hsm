...
export default class BlackeningScrooveOut extends React.Component{
    constructor(props){
        super(props);
    ...
    addValues = (text, index) => {
      ...
      clickhandler(){
        ...
        if(this.state.inputData&&this.state.inputData.length){
            ...
            axios.post("https://highgrip.in/api/BlackeningOut",{data:this.state.inputData})
            .then((response)=>{
...
const styles = StyleSheet.create({
    ...
    head:{ 
        ...
        inkg:{borderWidth:1,alignSelf:"flex-start",color:"#fff",paddingTop:10, paddingBottom:10,paddingLeft:4, paddingRight:4, width:"32%",color:"#000",textAlign:"center",},
    size:{
        alignSelf:"flex-start",padding:7,width:"31%", fontFamily:"serif",textShadowColor:"#000", textShadowColor: 'black',  textShadowOffset: { width: 1, height: 1 },
