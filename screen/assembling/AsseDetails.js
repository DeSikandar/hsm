...
export default class AssemDetails extends React.Component{
    constructor(props){
        super(props);
        ...
        if(this.state.inputData && this.state.inputData.length){
          if(this.state.slec&& this.state.slec.length){
            if(this.state.slec.length==this.state.inputData.length){
              ...
              axios.post("https://highgrip.in/api/Insertassout",{sizes:this.state.inputData,id:this.state.id,to:this.state.slec})
              .then(response=>{
