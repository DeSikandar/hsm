...
export default class Nailstore extends React.Component{
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        ...
        return fetch(`https://highgrip.in/api/getNailStocks`)
    ...
    render(){
        ...
        if(isLoading){
            ...
            <Text style={styles.head}>Nails Stock</Text>
            <View>
            ...
            <ScrollView style={{width:"100%"}}>{_items}</ScrollView>
