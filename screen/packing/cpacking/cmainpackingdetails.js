...
export default class MainpackingDetails extends React.Component{
    constructor(props){
        super(props);
        ...
        if(isLoading){
            ...
            var _items = dataSource.map((key,value) => {
                ...
                return <View  key={value} style={styles.bg}>
                        ...
                        <View style={{borderWidth:1,alignSelf:"flex-start",width:"35%", height:"75%", marginRight:10,}}>
                        ...
                        <TextInput style={{borderWidth:1,alignSelf:"flex-start",padding:10,width:"25%", height:"75%",textAlign:"center",}} placeholder="Enter Bag" onChangeText={(text) => this.addValues(text, key.id)} />
...
const styles = StyleSheet.create({
   ...
   brand:{
       padding:7,width:"35%", fontFamily:"serif",textShadowColor:"#000", textShadowColor: 'black',  textShadowOffset: { width: 1, height: 1 },
                      textShadowRadius: 3, fontSize:18,marginBottom:10,marginRight:10, color:"#fff", fontFamily:"serif",backgroundColor:"#00CCCC",textAlign:"center",
                      borderRadius:3,
                      shadowColor: "#000",
                      shadowOffset: {	width: 0,	height: 2,},shadowOpacity: 0.25,shadowRadius: 3.84,elevation: 5,
  ...
  pkt:{
    padding:7,width:"25%", fontFamily:"serif",textShadowColor:"#000", textShadowColor: 'black',  textShadowOffset: { width: 1, height: 1 },
